...
export default class App extends React.Component {
    ...
    */
    fetch('/api/todos', {
      ...
      .then(newTodo => {
        ...
        const newArr = copy.concat(newTodo);
  ...
  toggleCompleted(todoId) {
     ...
     */
    let current = null;
    this.state.todos.forEach((object, index) => {
      if (object.todoId === todoId) {
        current = index;
      }
    });
    const completed = this.state.todos[current].isCompleted;
    const newObj = { isCompleted: !completed };
